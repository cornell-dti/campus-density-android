...
class MainFeedbackOverallFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_main_feedback_overall, container, false)
    }
    ...
    private fun setButtonNext() {
        ...
        buttonNext.setOnClickListener {
            (parentFragment as MainFeedbackDialogFragment).overallInput = selectedAnswer
            viewPager.setCurrentItem((parentFragment as MainFeedbackDialogFragment).getPagerItem(1), false)
        }
    }
    ...
    private fun setBars(rating: Int) {
        when (rating) {
            ...
            R.id.first_radio -> setBarColors(R.color.very_crowded, R.color.filler_boxes, R.color.filler_boxes, R.color.filler_boxes)
            R.id.second_radio -> setBarColors(R.color.pretty_crowded, R.color.pretty_crowded, R.color.filler_boxes, R.color.filler_boxes)
            R.id.third_radio -> setBarColors(R.color.pretty_empty, R.color.pretty_empty, R.color.pretty_empty, R.color.filler_boxes)
            R.id.fourth_radio -> setBarColors(R.color.very_empty, R.color.very_empty, R.color.very_empty, R.color.very_empty)
        }
    }
